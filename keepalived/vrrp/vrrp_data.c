...
alloc_saddress(const vector_t *strvec)
{
  ...
  alloc_ipaddress( NULL, vrrp_data->static_addresses, strvec, NULL, true);
}
...
alloc_vrrp_vip(const vector_t *strvec)
{
  ...
  alloc_ipaddress( vrrp, vrrp->vip, strvec, vrrp->ifp, false);
...
alloc_vrrp_evip(const vector_t *strvec)
{
  ...
  alloc_ipaddress( vrrp, vrrp->evip, strvec, vrrp->ifp, false);
}
